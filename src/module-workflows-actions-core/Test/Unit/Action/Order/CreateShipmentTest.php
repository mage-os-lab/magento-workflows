...
class CreateShipmentTest extends TestCase
{
    ...
    private function createShipOrderStub(): ShipOrderInterface
    {
        return new class implements ShipOrderInterface {
            public function execute($orderId, array $items = [], $notify = false, $appendComment = false, $comment = null, array $tracks = [], array $packages = [], $arguments = null): int { throw new \RuntimeException('Should not be called'); }
        };
    }
}
