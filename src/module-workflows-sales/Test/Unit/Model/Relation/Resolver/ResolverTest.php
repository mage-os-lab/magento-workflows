...
namespace MageOS\WorkflowsSales\Test\Unit\Model\Relation\Resolver;

use Magento\Customer\Api\CustomerRepositoryInterface;
use Magento\Framework\Api\SearchCriteriaBuilder;
use Magento\Framework\DataObject;
use Magento\Sales\Api\OrderRepositoryInterface;
use MageOS\WorkflowsSales\Model\Relation\Resolver\OrderCustomer;
use MageOS\WorkflowsSales\Model\Relation\Resolver\OrderCustomerByEmail;
use MageOS\WorkflowsSales\Model\Relation\Resolver\OrderOrdersByEmail;
use MageOS\WorkflowsSales\Model\Relation\Resolver\QuoteCustomerByEmail;
use PHPUnit\Framework\TestCase;

/**
 * Sales seed relation resolvers (docs/discovery/entity-cross-referencing.md
 * §4–5): order.customer, order.customer_by_email, quote.customer_by_email and
 * order.orders_by_email. Split out of the engine's ResolverTest when these
 * resolvers moved to mage-os/workflows-sales (domain-packs S1); the
 * customer.open_orders resolver keeps its coverage in the engine suite.
 *
