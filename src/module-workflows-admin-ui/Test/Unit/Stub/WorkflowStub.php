...
namespace MageOS\WorkflowsAdminUi\Test\Unit\Stub;

use MageOS\Workflows\Api\Data\WorkflowInterface;

/**
 * Lightweight WorkflowInterface for admin-ui unit tests: getters back a data
 * bag, setters mutate it. No ORM, no resource model. Mirrors the peer stubs
 * in module-workflows and module-workflows-scheduler (Test/Unit/Stub/WorkflowStub.php).
 */
