 ...
 * composite), and the edit form's Run Now entity picker. Every one of them boots
 * declaratively via data-mage-init — none is referenced from an inline script.
 *
...
var config = {
    map: {
        '*': {
            ...
            mageosWorkflowsRunNow: 'MageOS_WorkflowsAdminUi/js/run-now-modal'
        }
    }
};
